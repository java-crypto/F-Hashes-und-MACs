...
public class F01_Md5File {

	public static void main(String[] args) throws Exception {
		System.out.println("F01 MD5 Hashfunktion mit einer Datei");
		...
		byte[] hashByte = generateMd5DoNotUse(filenameString);
		System.out.println("\nMD5-Hashwert der Datei:" + filenameString);
		System.out.println(
				"hashByte Länge:" + hashByte.length + " Data:" + printHexBinary(hashByte));
		System.out.println("\nF01 MD5 Hashfunktion mit einer Datei beendet");
	}
